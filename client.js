var frontpage = [
	"欢迎来到迷你匿名聊天室",
	"通过https://xxxx.com?your-channel创建和加入频道。 没有频道列表，因此可以使用秘密频道名称进行私人讨论。",
	
	"这是一个为你生成的随机的聊天室: ?" + Math.random().toString(36).substr(2, 8),
	
	"格式:",
	"空白被保留，所以源代码可以逐字地粘贴。",
	"用一个美元符号把LaTeX数学符号包起来作为内部书写格式 $\\zeta(2) = \\pi^2/6$, 两个美元符号用来显示. $$\\int_0^1 \\int_0^1 \\frac{1}{1-xy} dx dy = \\frac{\\pi^2}{6}$$",
	"",
	"服务器上不保留消息历史记录",
].join("\n")
